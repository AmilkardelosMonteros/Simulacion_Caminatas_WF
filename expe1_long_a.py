...
x_init = 0
y_init = 0.5
nombre = 'Experimento1_longevidad_a_'+'frecuencia_'+str(frec_inicial)+'_u1_'+str(a1)+'%'+str(b1)+'_u2_'+str(a2)+'%'+ str(b2)+'.txt'
...
def probabilidades(s,a1):
    s_barra =  u2/(1+s)
    s_barra_neg  = -u2/(1+s)

    p_mas_mas = probafixM1(s_barra*((1+d1)/(1+d1+a1)),(a1*(1+d1) -a0*(1+d1))/((1+d1+a1)*(1+d1)),frec_inicial)
    p_mas_menos = probafixM1(s_barra_neg*((1+d1)/(1+d1+a1)),(a1*(1+d1) -a0*(1+d1))/((1+d1+a1)*(1+d1)),frec_inicial)
